...
Flight.destroy_all
f1 = Flight.create :date => "2020-11-05", :flightnumber => "1000", :departure => "SYD" , :arrival => "JFK":plane => "1", :seats => "20"
f2 = Flight.create :date => "2020-11-06", :flightnumber => "500", :departure => "SYD" , :arrival => "JFK":plane => "1", :seats => "20"
f3 = Flight.create :date => "2020-11-07", :flightnumber => "1500", :departure => "SYD" , :arrival => "JFK":plane => "1", :seats => "20"
